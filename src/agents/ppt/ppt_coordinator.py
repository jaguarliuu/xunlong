...
{{
  ...
  "detail_text": "根据Precedence Research数据，全球AI语言模型市场规模从2025年的56亿美元增长至2030年预计的361亿美元。OpenAI、Google、Anthropic三家占据70%市场份额，其中OpenAI的ChatGPT用户突破2亿。中国市场方面，较2022年增加1342.83亿元，增幅288%。百度文心一言、阿里通义千问、腾讯混元等国产大模型竞相推出。"
}}
```
  ...
  "slides": [
    ...
    {{
      ...
      "content": {{
        "title": "市场规模快速增长",
        "main_points": [
          "2025年市场规模达4850亿元，同比增长33.8%",
          "预计2026年突破万亿，年复合增长率30%+",
          "B端占比65%，C端增速45%领先",
          "头部企业C端营收占比超40%"
        ],
        "detail_text": "数据来源：艾媒咨询2025年预制菜行业报告"
      }}
    }},
    {{
      "slide_number": 3,
